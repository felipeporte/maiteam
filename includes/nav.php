...
<nav class="main-menu">
  ...
  <ul>
    ...
    <li class="nav-item <?= $actual === 'perfil.php' ? 'active' : '' ?>">
      <b></b><b></b>
    ...
    <li class="nav-item <?= $actual === 'actividades.php' ? 'active' : '' ?>">
      <b></b><b></b>
      <a href="actividades.php"><i class="fa fa-person-running nav-icon"></i><span class="nav-text">Deportista</span></a>
    </li>
